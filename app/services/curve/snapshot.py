...
def get_pool_snapshots(chain: str, pool: str) -> Mapping[str, List[CurvePoolSnapshot]]:
...
def get_pool_volume_snapshots(chain: str, pool: str) -> Mapping[str, List[CurvePoolVolumeSnapshot]]:
...
def get_pool_fee_snapshots(chain: str, pool: str) -> Mapping[str, List[CurvePoolFeeSnapshot]]:
...
def get_pool_tvl_snapshots(chain: str, pool: str) -> Mapping[str, List[CurvePoolTVLSnapshot]]:
...
def get_pool_reserves_snapshots(chain: str, pool: str) -> Mapping[str, List[CurvePoolReserveSnapshot]]:
