...
def get_platform_revenue_snapshots() -> List[ConvexRevenueSnapshot]:
    ...
    return ConvexRevenueSnapshotSchema(many=True).load(
        _exec_query(query, "ConvexPlatformRevenue"), unknown=EXCLUDE
    )
